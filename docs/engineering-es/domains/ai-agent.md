...
Pendientes del plan original: conectar pruebas sintéticas específicas por rol y su procedencia con la comparativa; sustituir la justificación genérica de conservación por utilidad reutilizable y diferencias frente a perfiles existentes; ofrecer una comparación de los mismos casos entre Todoterreno, Directivo siempre activo y rutas directas. Ya existen el medidor y los casos simulados. La evaluación genérica tiene tres casos y no acredita catalán, citas ni coordinación. Las instrucciones reutilizables requieren revisión humana: aceptar no elimina automáticamente detalles particulares. Este cambio no ejecuta pruebas con proveedores reales.
