...
Aquesta directiva estableix els estàndards per mantenir la UI "Premium" de Gnosi i evitar regressions a versions obsoletes de "Gnosi".

## 1. Branding Oficial
- **Nom del Producte**: Gnosi (MAI "Gnosi").
