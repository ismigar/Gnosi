...
4. **Shared Tab Styling**: Reuse `SettingsSectionTabs` for section-level tabs instead of introducing page-specific pill buttons. Do not add a manual refresh control when the view already polls and refreshes after mutations.
