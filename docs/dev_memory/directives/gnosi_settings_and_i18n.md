...
- The compact agent-icon trigger and every icon tile use the corporate blue
  background with a white icon, matching the floating microphone control.
  Distinguish the selected tile with an outline instead of reversing its colors.
