...
- **Success Criteria:** A valid n8n JSON file is created in `monorepo/apps/gnosi/pipeline/sandbox/temenos_workflow.json` which includes all requested nodes and logic.
...
- **Generated Artifacts:**
    - `monorepo/apps/gnosi/pipeline/sandbox/temenos_workflow.json`: The n8n workflow JSON.
...
```bash
python monorepo/apps/gnosi/pipeline/sandbox/generate_temenos_workflow.py
```
