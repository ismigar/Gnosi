...
## Objectiu
Mantenir la compatibilitat total entre l'editor de blocs (Gnosi) i els editors de text pla (Obsidian), permetent alhora funcionalitats avançades de disseny (Connector importació Notion-like) i facilitant el processament per part de LLMs.
