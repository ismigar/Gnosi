...
| Surface | Count |
| --- | ---: |
| Backend Python files | 451 |
| Backend Python test files | 185 |
| Frontend JS/TS source files | 357 |
...
| `frontend/src/` | 379 | React application, UI behavior, state, and browser integrations |
