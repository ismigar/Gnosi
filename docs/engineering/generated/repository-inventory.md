...
| Surface | Count |
| --- | ---: |
| Backend Python files | 443 |
| Backend Python test files | 184 |
| Frontend JS/TS source files | 353 |
| Frontend unit test files | 71 |
...
| --- | ---: | --- |
| `backend/` | 455 | FastAPI, services, models, agents, scheduling, and storage adapters |
| `frontend/src/` | 375 | React application, UI behavior, state, and browser integrations |
