...
| Frontend JS/TS source files | 1405 |
| Frontend unit test files | 405 |
...
| `frontend/src/` | 1475 | React application, UI behavior, state, and browser integrations |
| `pipeline/` | 143 | Reusable application skills and deterministic processing tools |
| `desktop/` | 60 | Desktop lifecycle, backend packaging, IPC, and updates |
