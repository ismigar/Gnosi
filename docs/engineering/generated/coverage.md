...
| `vault-files` | **covered** | [`Vault and files`](../domains/vault-files.md) | 158 | 10 | 4 |
| `database-views-planning` | **covered** | [`Database views and project planning`](../domains/database-views-planning.md) | 16 | 8 | 3 |
