...
Restent à réaliser : relier les tests synthétiques spécifiques aux rôles et leur provenance à la comparaison ; remplacer la justification générique de conservation par une évaluation de l’utilité réutilisable et des différences avec les profils existants ; proposer une comparaison des mêmes cas avec généraliste, directeur toujours actif et routage direct. Le mesureur et les cas simulés existent. L’évaluation générique compte trois cas et ne certifie ni catalan, ni citations, ni coordination. Les instructions réutilisables nécessitent une révision humaine : l’acceptation ne supprime pas automatiquement les détails particuliers. Aucun test auprès de fournisseurs réels n’a été exécuté ici.
