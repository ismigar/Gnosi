...
La comparaison présente d’abord le modèle et ses évaluations par rôle, puis coût mensuel estimé et fournisseur, suivis d’intelligence, contexte, prix d’entrée/sortie, modes, paramètres, vitesse, latence et scores spécialisés. Les titres compacts conservent unités et infobulles complètes ; les filtres sont alignés, Modes se ferme en cliquant ailleurs et les tokens mensuels regroupent les milliers. Le pied reste dégagé de la barre horizontale.
