...
Sélectionner un profil trie par adéquation estimée. Les candidats sans données suffisantes restent visibles, avec les scores inconnus en dernier. Comparer tous les candidats efface les filtres facultatifs en conservant le profil et le volume de tokens. Aucun test n’est nécessaire pour choisir un modèle.
