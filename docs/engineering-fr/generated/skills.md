...
| --- | --- | ---: | ---: | --- |
| `auto_improver` | SKILL: Native Auto Improver | 22 | 2 | [`pipeline/skills/auto_improver/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/auto_improver/SKILL.md) |
| `autonomous_loop` | SKILL: Autonomous Loop (Orchestration) | 45 | 0 | [`pipeline/skills/autonomous_loop/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/autonomous_loop/SKILL.md) |
| `backup_projectes` | SKILL: Projectes Daily Backup | 75 | 1 | [`pipeline/skills/backup_projectes/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/backup_projectes/SKILL.md) |
| `calendar_sync` | SKILL: Calendar Sync | 34 | 1 | [`pipeline/skills/calendar_sync/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/calendar_sync/SKILL.md) |
...
| `playwright_e2e` | SKILL: Playwright E2E | 177 | 2 | [`pipeline/skills/playwright_e2e/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/playwright_e2e/SKILL.md) |
...
| `publisher` | SKILL: Publisher | 55 | 0 | [`pipeline/skills/publisher/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/publisher/SKILL.md) |
| `rss_to_audio` | SKILL: RSS to Audio Podcast | 86 | 1 | [`pipeline/skills/rss_to_audio/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/rss_to_audio/SKILL.md) |
...
| `technical_documentation` | SKILL: Technical documentation | 120 | 5 | [`pipeline/skills/technical_documentation/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/technical_documentation/SKILL.md) |
| `translate_page` | Skill: translate_page | 104 | 3 | [`pipeline/skills/translate_page/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/translate_page/SKILL.md) |
...
| `vault_core` | SKILL: Vault Core Management | 46 | 0 | [`pipeline/skills/vault_core/SKILL.md`](https://github.com/ismigar/Gnosi/blob/main/pipeline/skills/vault_core/SKILL.md) |
