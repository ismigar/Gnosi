...
| Vitest | [`frontend/src/components/AppSidebar.test.jsx`](https://github.com/ismigar/Gnosi/blob/main/frontend/src/components/AppSidebar.test.jsx) | 1 | call-pattern estimate |
...
| Vitest | [`frontend/src/components/GlobalTooltip.test.jsx`](https://github.com/ismigar/Gnosi/blob/main/frontend/src/components/GlobalTooltip.test.jsx) | 6 | call-pattern estimate |
...
| Vitest | [`frontend/src/components/Notebooks/NotebookCreateDialog.test.jsx`](https://github.com/ismigar/Gnosi/blob/main/frontend/src/components/Notebooks/NotebookCreateDialog.test.jsx) | 3 | call-pattern estimate |
...
| Vitest | [`frontend/src/lib/fileResourceCitation.test.js`](https://github.com/ismigar/Gnosi/blob/main/frontend/src/lib/fileResourceCitation.test.js) | 4 | call-pattern estimate |
...
| Vitest | [`frontend/tests/account_management.spec.js`](https://github.com/ismigar/Gnosi/blob/main/frontend/tests/account_management.spec.js) | 1 | call-pattern estimate |
...
| Vitest | [`frontend/tests/rich_link_insert.spec.js`](https://github.com/ismigar/Gnosi/blob/main/frontend/tests/rich_link_insert.spec.js) | 3 | call-pattern estimate |
| Vitest | [`frontend/tests/vault_design_regression.spec.js`](https://github.com/ismigar/Gnosi/blob/main/frontend/tests/vault_design_regression.spec.js) | 1 | call-pattern estimate |
...
| pytest | [`backend/tests/test_agent_quality_telemetry.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_agent_quality_telemetry.py) | 5 | Python AST |
...
| pytest | [`backend/tests/test_agent_resilience.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_agent_resilience.py) | 13 | Python AST |
...
| pytest | [`backend/tests/test_agent_skill_runtime.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_agent_skill_runtime.py) | 36 | Python AST |
...
| pytest | [`backend/tests/test_connection_scheduler_alignment.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_connection_scheduler_alignment.py) | 3 | Python AST |
...
| pytest | [`backend/tests/test_notebook_agent_context.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_notebook_agent_context.py) | 3 | Python AST |
| pytest | [`backend/tests/test_notebook_service.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_notebook_service.py) | 9 | Python AST |
...
| pytest | [`backend/tests/test_plugin_system.py`](https://github.com/ismigar/Gnosi/blob/main/backend/tests/test_plugin_system.py) | 29 | Python AST |
...
| pytest | [`extensions/mcp/drupal-proxy/test_proxy.py`](https://github.com/ismigar/Gnosi/blob/main/extensions/mcp/drupal-proxy/test_proxy.py) | 0 | Python AST |
...
| pytest | [`test_ingestion.py`](https://github.com/ismigar/Gnosi/blob/main/test_ingestion.py) | 0 | Python AST |
| pytest | [`test_pkg.py`](https://github.com/ismigar/Gnosi/blob/main/test_pkg.py) | 0 | Python AST |
