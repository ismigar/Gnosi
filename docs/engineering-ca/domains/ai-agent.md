...
Pendents del pla original: connectar les proves sintètiques específiques per paper i les seves evidències amb la comparativa; substituir la justificació genèrica de conservació per una valoració d’utilitat reutilitzable i diferències respecte dels perfils existents; oferir una comparació dels mateixos casos entre Tot terreny, Directiu sempre actiu i rutes directes. Ja existeixen el mesurador i els casos simulats. L’avaluació genèrica actual té tres casos i no acredita català, cites ni coordinació. Les instruccions reutilitzables requereixen revisió humana: l’acceptació no elimina automàticament dades particulars. Aquest canvi no ha executat proves amb proveïdors reals.
