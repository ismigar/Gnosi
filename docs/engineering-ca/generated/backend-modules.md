...
| [`backend/app/routes.py`](https://github.com/ismigar/Gnosi/blob/main/backend/app/routes.py) | 164 | 0 | 1 | 0 | 1 | Single ordered registry for every public Gnosi router. |
