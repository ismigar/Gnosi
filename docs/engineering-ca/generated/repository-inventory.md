...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1058 |
| Backend Python test files | 322 |
...
| --- | ---: | --- |
| `backend/` | 1072 | FastAPI, services, models, agents, scheduling, and storage adapters |
...
| `scripts/` | 24 | Native, self-host, release, and maintenance scripts |
