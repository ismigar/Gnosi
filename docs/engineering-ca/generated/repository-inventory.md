...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1315 |
| Backend Python test files | 500 |
| Frontend JS/TS source files | 1906 |
| Frontend unit test files | 536 |
...
| --- | ---: | --- |
| `backend/` | 1333 | FastAPI, services, models, agents, scheduling, and storage adapters |
| `frontend/src/` | 1986 | React application, UI behavior, state, and browser integrations |
