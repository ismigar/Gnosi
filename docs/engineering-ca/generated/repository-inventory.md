...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1314 |
| Backend Python test files | 499 |
| Frontend JS/TS source files | 1901 |
| Frontend unit test files | 533 |
...
| --- | ---: | --- |
| `backend/` | 1332 | FastAPI, services, models, agents, scheduling, and storage adapters |
| `frontend/src/` | 1981 | React application, UI behavior, state, and browser integrations |
