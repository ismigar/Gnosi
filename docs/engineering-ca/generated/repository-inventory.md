...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1289 |
| Backend Python test files | 489 |
| Frontend JS/TS source files | 1866 |
| Frontend unit test files | 521 |
...
| --- | ---: | --- |
| `backend/` | 1307 | FastAPI, services, models, agents, scheduling, and storage adapters |
