...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1294 |
| Backend Python test files | 492 |
...
| --- | ---: | --- |
| `backend/` | 1312 | FastAPI, services, models, agents, scheduling, and storage adapters |
...
| `desktop/` | 361 | Desktop lifecycle, backend packaging, IPC, and updates |
