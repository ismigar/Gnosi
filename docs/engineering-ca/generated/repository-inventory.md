...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1381 |
| Backend Python test files | 520 |
| Frontend JS/TS source files | 1959 |
| Frontend unit test files | 553 |
...
| --- | ---: | --- |
| `backend/` | 1493 | FastAPI, services, models, agents, scheduling, and storage adapters |
