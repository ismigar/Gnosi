...
| Àrea | Recompte |
| --- | ---: |
| Backend Python files | 1356 |
| Backend Python test files | 512 |
| Frontend JS/TS source files | 1935 |
| Frontend unit test files | 546 |
...
| --- | ---: | --- |
| `backend/` | 1374 | FastAPI, services, models, agents, scheduling, and storage adapters |
| `frontend/src/` | 2016 | React application, UI behavior, state, and browser integrations |
