...
/**
 * Service to clean unused file entities created by Vault Bridge.
 */
class Cleaner {
  ...
  /**
   * The logger service for vault_migration.
   *
  ...
  /**
   * Constructs the VaultMigrationCleaner service.
   *
  ...
  public function __construct(
    ...
    $this->logger = $loggerFactory->get('vault_migration');
