 ...
 * @endcode
 */
$settings['hash_salt'] = 'r-Vc7hynNBUPOThNHQ0jRB6Wn_xtSxgCZphfRgZV1RW2jOJVgvF_nbniI7DHJhxVHQtuQ3JYEQ';
 ...
 */
$settings['file_private_path'] = '../drupal_private_files';
...
$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^ismigar\.pangea\.org$',
  '^www\.ismigar\.pangea\.org$',
  '^temenosismael\.org$',
  '^www\.temenosismael\.org$',
];
...
$settings['php_settings']['memory_limit'] = '512M';
