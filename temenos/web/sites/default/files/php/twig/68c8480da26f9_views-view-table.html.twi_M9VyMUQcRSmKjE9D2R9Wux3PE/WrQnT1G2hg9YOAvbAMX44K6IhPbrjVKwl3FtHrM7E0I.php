...
/* themes/custom/elraco/templates/views/views-view-table.html.twig */
class __TwigTemplate_30323eef8366149d5eb6aa7a776dbb8b extends Template
{
    ...
    ";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                // line 103
                yield "          <td data-label=\"";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::trim(Twig\Extension\CoreExtension::striptags(CoreExtension::getAttribute($this->env, $this->source, (($_v1 = ($context["header"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess && in_array($_v1::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v1[CoreExtension::getAttribute($this->env, $this->source, $context["column"], "index", [], "any", false, false, true, 103)] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["header"] ?? null), CoreExtension::getAttribute($this->env, $this->source, $context["column"], "index", [], "any", false, false, true, 103), [], "array", false, false, true, 103)), "content", [], "any", false, false, true, 103))), "html", null, true);
                yield "\"";
...
";
    ...
    {
        return "themes/custom/elraco/templates/views/views-view-table.html.twig";
    }
    ...
    {
        return array (  266 => 119,  259 => 117,  252 => 115,  244 => 112,  240 => 111,  235 => 109,  225 => 107,  221 => 106,  216 => 105,  214 => 104,  208 => 103,  205 => 102,  199 => 101,  196 => 100,  191 => 99,  189 => 95,  187 => 94,  184 => 93,  180 => 92,  175 => 91,  171 => 90,  168 => 89,  163 => 86,  156 => 84,  151 => 81,  141 => 79,  139 => 78,  134 => 76,  130 => 74,  120 => 72,  118 => 71,  114 => 70,  112 => 69,  108 => 68,  105 => 67,  103 => 64,  102 => 62,  100 => 61,  97 => 60,  93 => 59,  89 => 57,  86 => 56,  82 => 54,  76 => 52,  73 => 51,  67 => 49,  61 => 47,  59 => 46,  56 => 45,  54 => 44,  49 => 43,  47 => 40,  46 => 39,  45 => 38,  44 => 35,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/elraco/templates/views/views-view-table.html.twig", "/home/ismigar/webapps/web/web/themes/custom/elraco/templates/views/views-view-table.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["set" => 35, "if" => 44, "for" => 59];
        static $filters = ["length" => 38, "escape" => 43, "merge" => 100, "trim" => 103, "striptags" => 103];
        static $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set', 'if', 'for'],
                ['length', 'escape', 'merge', 'trim', 'striptags'],
                [],
                $this->source
            );
