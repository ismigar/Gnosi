...
async function clearTags() {
    console.log("Fetching pages with tags in Bitacora DB...");
    ...
    for (const page of pagesToUpdate) {
        let title = "Untitled";
        if (page.properties.Títol && page.properties.Títol.title && page.properties.Títol.title.length > 0) {
            title = page.properties.Títol.title[0].plain_text;
        }
