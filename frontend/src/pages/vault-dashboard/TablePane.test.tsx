...
import type { VaultViewBodyProps } from '../../components/Vault/VaultViewBody';
...
vi.mock('../../components/Vault/VaultViewBody', () => ({
  VaultViewBody: (props: VaultViewBodyProps) => { probe(props); return <div>Real dashboard boundary</div>; },
}));
vi.mock('../../components/Vault/VaultViewsHeader', () => ({ VaultViewsHeader: () => null }));
vi.mock('../../components/Vault/VaultGraph', () => ({ VaultGraph: () => null }));
