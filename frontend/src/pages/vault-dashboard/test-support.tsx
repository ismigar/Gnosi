...
vi.mock('../../plugins/usePlugins', () => ({ usePlugins: () => plugins }));
vi.mock('../../lib/toast', () => ({ toast: Object.assign(vi.fn(), { success: vi.fn(), error: vi.fn(), dismiss: vi.fn() }) }));
vi.mock('../../lib/notifyError', () => ({ notifyError: vi.fn(), logError: vi.fn() }));
