...
import { getLocaleMeta } from '../../../shared/i18n/locales/registry';
import { uiLangToZoteroLocale } from '../../../shared/citations/zoteroLocale';
...
export function ZoteroReaderTab({
  ...
  const {
    ...
    loadErrorMessage: t('pdf.load_error', 'The PDF reader could not load. Update Gnosi and try again.'),
