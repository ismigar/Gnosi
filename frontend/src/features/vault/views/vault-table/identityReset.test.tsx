...
vi.mock('../../../../shared/plugins/usePlugins', () => ({ usePlugins: () => ({ isEnabled: fixture.reader, getPluginSettings: () => ({}) }) }));
vi.mock('../../../../shared/api/brain', () => ({ fetchLlmWikiConfig: fixture.fetchConfig }));
vi.mock('../../../../shared/auth/auth-context', () => ({ useAuth: () => ({ user: null }) }));
vi.mock('../../../../shared/i18n/useLocaleSettings', () => ({ useLocaleSettings: () => ({}) }));
