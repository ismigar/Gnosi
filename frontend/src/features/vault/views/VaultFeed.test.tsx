...
vi.mock('../../../shared/editor/useTitlePreview', () => ({ useTitlePreview: () => ({ getTitleProps: () => ({}), preview: null }) }));
vi.mock('../../../shared/editor/VaultMarkdown', () => ({ VaultMarkdown: ({ md }: { readonly md: string }) => <p>{md}</p> }));
...
vi.mock('../../../shared/notifications/toast', () => ({ toast: { success: vi.fn(), error: vi.fn() } }));
