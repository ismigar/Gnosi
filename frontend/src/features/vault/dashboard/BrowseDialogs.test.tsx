...
import type { GlobalSearchModalProps } from '../../../shared/page-search/GlobalSearchModal';
...
vi.mock('../../../shared/page-search/GlobalSearchModal', () => ({
  GlobalSearchModal: (props: GlobalSearchModalProps) => { probe(props); return null; },
}));
vi.mock('../navigation/TagsModal', () => ({ default: () => null }));
vi.mock('../editor/PresentationMode', () => ({ default: () => null }));
vi.mock('../comments/InlineComments', () => ({ default: () => null }));
vi.mock('../navigation/WorkspacesModal', () => ({ default: () => null }));
vi.mock('../../literature/records/MetadataLookupModal', () => ({ MetadataLookupModal: () => null }));
vi.mock('../navigation/RecentModal', () => ({ RecentModal: () => null }));
vi.mock('../editor/TranslateLanguagesModal', () => ({ TranslateLanguagesModal: () => null }));
vi.mock('../../literature/records/ProcessResourceModal', () => ({ ProcessResourceModal: () => null }));
