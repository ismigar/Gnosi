...
export function SkillInstructions({ skill }: { skill: NormalizedSkill }) {
    ...
    return <div>
        ...
        {translation.error && <p role="status" className="ai-resource-muted">{t(translation.rateLimited ? 'settings.ai.resources.instructions_translation_rate_limit' : 'settings.ai.resources.instructions_translation_error')}</p>}
