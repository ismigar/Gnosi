        ...
        <div id="gnosi-presentation" className="fixed inset-0 z-[100003] flex flex-col bg-[var(--bg-primary)]">
            ...
            <div className="flex items-center justify-between px-4 py-2 text-[var(--text-tertiary)]">
                ...
                <div className="flex items-center gap-1">
                    <button onClick={goFullscreen} title="Pantalla completa" className="rounded p-1.5 hover:bg-[var(--bg-secondary)]"><Maximize2 size={16} /></button>
                    <button onClick={onClose} title="Surt (Esc)" className="rounded p-1.5 hover:bg-[var(--bg-secondary)]"><X size={18} /></button>
                </div>
            </div>
            {/* Diapositiva */}
