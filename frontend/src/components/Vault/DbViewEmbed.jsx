...
function applyFilter(row, pageId, f) {
    ...
    const filteredValue = periodBoundary(v, f.periodPart);
    const arr = Array.isArray(filteredValue) ? filteredValue.map(String) : filteredValue == null || filteredValue === '' ? [] : [String(filteredValue)];
