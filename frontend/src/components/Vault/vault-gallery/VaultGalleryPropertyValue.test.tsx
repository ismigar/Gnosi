...
import type { RelationItemProps } from '../RelationItem';
import { RELATION_UNLINKED_EVENT } from '../relationItemUtils';
...
vi.mock('../RelationItem', () => ({ RelationItem: (props: RelationItemProps) => {
