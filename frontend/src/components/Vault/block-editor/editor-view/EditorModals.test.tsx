...
import type { InsertContentModalProps, InsertContentResult } from '../../InsertContentModal';
import type { CitePicker } from '../../CitePicker';
...
vi.mock('../../InsertContentModal', () => ({ InsertContentModal: (props: InsertContentModalProps) => { observed.insert = props; return <div data-modal="insert" />; } }));
vi.mock('../../CitePicker', () => ({ CitePicker: (props: ComponentProps<typeof CitePicker>) => { observed.cite = props; return <div data-modal="cite" />; } }));
vi.mock('../../AIGenerateModal', () => ({ default: (props: ComponentProps<typeof AIGenerateModal>) => { observed.ai = props; return <div data-modal="ai" />; } }));
vi.mock('../../../PromptModal', () => ({ default: (props: PromptModalProps) => { observed.prompt = props; return <div data-modal="prompt" />; } }));
