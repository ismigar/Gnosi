        ...
        <div className="resources-plugin-config">
            ...
            <section className="resources-plugin-config__section">
                ...
                <div className="resources-plugin-config__row">
                    ...
                    <button type="button" className="btn-gnosi btn-gnosi-secondary resources-plugin-config__action" onClick={() => window.dispatchEvent(new CustomEvent('open-settings', { detail: 'api' }))}><KeyRound size={14} /> {t('literature.settings.manage_credentials')}</button>
                </div>
            </section>
