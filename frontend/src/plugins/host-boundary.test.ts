...
import type * as Runtime from '../shared/api/plugin-runtime';
import type * as Plugins from '../shared/api/plugins';
...
vi.mock('../shared/api/plugins', () => ({ fetchInstalledPlugins: mocks.list }));
...
vi.mock('../shared/api/page-etag', () => ({ getCachedPageEtag: () => undefined }));
vi.mock('../shared/api/vaults', () => ({ fetchVaultPagesByTable: vi.fn(), fetchVaultTables: vi.fn() }));
