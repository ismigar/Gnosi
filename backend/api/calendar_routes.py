...
@router.get("/calendars", response_model=None)
...
@router.post("/reminders/{reminder_id}/dismiss", response_model=None)
...
@router.get("/reminders/settings", response_model=None)
...
@router.put("/reminders/settings", response_model=None)
...
@router.post("/events", response_model=None, dependencies=[Depends(require_role("editor"))])
...
@router.post("/freebusy", response_model=None)
...
@router.post("/sync", response_model=None, dependencies=[Depends(require_role("editor"))])
...
@router.get("/attendees/search", response_model=None)
...
async def rsvp_event(event_id: str, body: dict[str, Any] = Body(...)) -> dict[str, Any]:
...
@router.post("/events/{event_id}/invite", response_model=None)
async def invite_to_event(event_id: str, body: dict[str, Any] = Body(...)) -> dict[str, Any]:
    """
...
@router.post("/events/{event_id}/hide", response_model=None)
...
@router.post("/events/{event_id}/unhide", response_model=None)
