    ...
    if stream_id == "mastodon-home":
        ...
        if not posts and not mastodon_client.bearer:
            return [{
                ...
                "handle": "@guide",
                "content": "Encara no has configurat el token de Mastodon.\n\n1. Ves a l'apartat de Desenvolupament\n2. Crea una App amb permisos 'read' i 'write'\n3. Copia el token a .env_shared",
        ...
        if not posts and not bluesky_client.app_password:
            return [{
                ...
                "handle": "@guide",
                "content": "Encara no has configurat la App Password de Bluesky.\n\n1. Ves a Settings -> App Passwords\n2. Crea'n una de nova\n3. Actualitza el fitxer .env_shared",
                "timestamp": datetime.now().isoformat(),
                "avatar": None,
                "favourited": False,
                "reblogged": False,
        ...
        if not my_posts:
            ...
            return [{
                ...
                "author": "System",
                "handle": "@system",
                "content": f"No hi ha publicacions recents a {network_name} des d'aquesta aplicació.\n\nUtilitza el botó 'New Post' per enviar el teu primer missatge!",
                "timestamp": datetime.now().isoformat(),
                "avatar": None,
                "favourited": False,
                "reblogged": False,
