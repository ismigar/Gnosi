...
| [`frontend/src/components/AI/AIQualitySettings.jsx`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/components/AI/AIQualitySettings.jsx) | 138 | `AIQualitySettingsPanel` | — |
...
| [`frontend/src/components/AI/useAIResources.js`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/components/AI/useAIResources.js) | 337 | `useAIResources` | `/api/ai/approvals`, `/api/ai/automations`, `/api/ai/capability-audit`, `/api/ai/jobs`, `/api/ai/quality/dashboard`, `/api/ai/semantic-associations`, `/api/ai/skills`, `/api/ai/tools` |
...
| [`frontend/src/components/AgentChat.jsx`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/components/AgentChat.jsx) | 2585 | `AgentChat` | `/api/chat`, `/api/chat/attachments`, `/api/chat/feedback`, `/api/config`, `/api/vault/databases`, `/api/vault/pages`, `/api/vault/tables` |
...
| [`frontend/src/components/Notebooks/NotebookCreateDialog.jsx`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/components/Notebooks/NotebookCreateDialog.jsx) | 228 | `NotebookCreateDialog`, `function` | `/api/notebooks` |
...
| [`frontend/src/hooks/useModalKeyboard.js`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/hooks/useModalKeyboard.js) | 204 | `pushModalLayer`, `useModalKeyboard` | — |
...
| [`frontend/src/pages/NotebooksPage.jsx`](https://github.com/ismigar/Gnosi/blob/main/apps/gnosi/frontend/src/pages/NotebooksPage.jsx) | 470 | `NotebooksPage`, `function` | — |
