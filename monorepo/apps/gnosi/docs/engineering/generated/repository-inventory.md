...
| Surface | Count |
| --- | ---: |
| Backend Python files | 452 |
| Backend Python test files | 190 |
| Frontend JS/TS source files | 358 |
| Frontend unit test files | 73 |
| Registered FastAPI routers | 36 |
| Runtime skill contracts | 23 |
| Development-memory directives | 194 |

## Owned application surfaces

| Surface | Files | Purpose boundary |
| --- | ---: | --- |
| `backend/` | 463 | FastAPI, services, models, agents, scheduling, and storage adapters |
| `frontend/src/` | 382 | React application, UI behavior, state, and browser integrations |
