...
| Frontend JS/TS source files | 329 |
| Frontend unit test files | 58 |
| Registered FastAPI routers | 33 |
| Runtime skill contracts | 23 |
| Development-memory directives | 175 |
...
| `frontend/src/` | 349 | React application, UI behavior, state, and browser integrations |
