...
async def get_vault_graph() -> Dict[str, Any]:
    ...
    """
    try:
        # build_unified_graph fa rglob al vault i càlcul de layout amb igraph
        # — pot trigar segons. Off-thread per no congelar l'event loop i
        # bloquejar tots els altres requests.
