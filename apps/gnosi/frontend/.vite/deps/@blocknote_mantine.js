import {
  ...
  yi,
  zl
} from "./chunk-4TPI7Y5U.js";
import "./chunk-IO4LENIE.js";
...
import "./chunk-OD724U3G.js";
import "./chunk-EXDYR63E.js";
...
function rgbStringToRgba(color) {
  const [r2, g2, b, a] = color.replace(/[^0-9,./]/g, "").split(/[/,]/).map(Number);
  return { r: r2, g: g2, b, a: a === void 0 ? 1 : a };
}
...
function darken(color, alpha2) {
  ...
  const { r: r2, g: g2, b, a } = toRgba(color);
  const f = 1 - alpha2;
  const dark = (input) => Math.round(input * f);
  return `rgba(${dark(r2)}, ${dark(g2)}, ${dark(b)}, ${a})`;
}
...
var defaultCssVariablesResolver = (theme) => {
  ...
  theme.colors[theme.primaryColor].forEach((_2, index3) => {
...
var varsResolver = createVarsResolver(
  (_2, { scrollbarSize, overscrollBehavior, scrollbars }) => {
...
var varsResolver9 = createVarsResolver((_2, { size: size2, radius, iconSize }) => ({
  root: {
...
// node_modules/@mantine/core/esm/components/Input/InputDescription/InputDescription.mjs
var varsResolver11 = createVarsResolver((_2, { size: size2 }) => ({
  description: {
...
var varsResolver12 = createVarsResolver((_2, { size: size2 }) => ({
  error: {
...
var varsResolver13 = createVarsResolver((_2, { size: size2 }) => ({
  label: {
...
var varsResolver14 = createVarsResolver((_2, { size: size2 }) => ({
  label: {
    "--input-label-size": getFontSize(size2),
    "--input-asterisk-color": void 0
  },
...
var varsResolver17 = createVarsResolver(
  (_2, { transitionDuration, chevronSize, radius }) => ({
    root: {
...
var varsResolver18 = createVarsResolver((_2, { zIndex, position }) => ({
  root: {
...
var varsResolver21 = createVarsResolver((_2, { size: size2, thumbSize }) => ({
  root: {
...
// node_modules/@mantine/core/esm/components/AspectRatio/AspectRatio.mjs
var varsResolver23 = createVarsResolver((_2, { ratio }) => ({
  root: {
...
var varsResolver25 = createVarsResolver((_2, { size: size2, dropdownPadding }) => ({
  options: {
...
var varsResolver26 = createVarsResolver((_2, { radius }) => ({
  card: {
...
// node_modules/@mantine/core/esm/components/Avatar/AvatarGroup/AvatarGroup.mjs
var varsResolver29 = createVarsResolver((_2, { spacing }) => ({
  group: {
...
// node_modules/@mantine/core/esm/components/BackgroundImage/BackgroundImage.mjs
var varsResolver31 = createVarsResolver((_2, { radius }) => ({
...
var varsResolver34 = createVarsResolver((_2, { separatorMargin }) => ({
  root: {
...
var varsResolver36 = createVarsResolver((_2, { borderWidth }) => ({
...
// node_modules/@mantine/core/esm/components/Card/Card.mjs
var varsResolver39 = createVarsResolver((_2, { padding }) => ({
  root: {
...
var varsResolver42 = createVarsResolver((_2, { radius, size: size2 }) => ({
  root: {
...
function rgbaToHsva({ r: r2, g: g2, b, a }) {
  const max = Math.max(r2, g2, b);
  const delta = max - Math.min(r2, g2, b);
  const hh = delta ? max === r2 ? (g2 - b) / delta : max === g2 ? 2 + (b - r2) / delta : 4 + (r2 - g2) / delta : 0;
  return {
...
function hsvaToRgba(color, includeAlpha) {
  const { r: r2, g: g2, b, a } = hsvaToRgbaObject(color);
  if (!includeAlpha) {
    return `rgb(${r2}, ${g2}, ${b})`;
  }
  return `rgba(${r2}, ${g2}, ${b}, ${round(a, 2)})`;
}
...
function hsvaToHex(color) {
  const { r: r2, g: g2, b } = hsvaToRgbaObject(color);
  return `#${formatHexPart(r2)}${formatHexPart(g2)}${formatHexPart(b)}`;
}
...
var varsResolver43 = createVarsResolver((_2, { size: size2, swatchesPerRow }) => ({
  wrapper: {
        ...
        withPicker && (0, import_jsx_runtime185.jsxs)(import_jsx_runtime185.Fragment, { children: [
          (0, import_jsx_runtime185.jsx)(
            Saturation,
            {
              ...
              onChangeEnd: ({ s: s2, v: v2 }) => onChangeEnd?.(convertHsvaTo(formatRef.current, { ...parsed, s: s2, v: v2 })),
              color: _value,
              size: size2,
              focusable: focusable2,
              saturationLabel,
...
var varsResolver44 = createVarsResolver((_2, { size: size2 }) => ({
  eyeDropperIcon: {
...
// node_modules/@mantine/core/esm/components/Container/Container.mjs
var varsResolver45 = createVarsResolver((_2, { size: size2, fluid }) => ({
  root: {
...
var varsResolver46 = createVarsResolver((_2, { size: size2 }) => ({
  root: {
...
var varsResolver48 = createVarsResolver((_2, { position, size: size2, offset: offset2 }) => ({
  root: {
...
var varsResolver49 = createVarsResolver((_2, { radius }) => ({
  root: {
...
var varsResolver50 = createVarsResolver((_2, { justify, align, overflow }) => ({
  root: {
...
// node_modules/@mantine/core/esm/components/Image/Image.mjs
var varsResolver52 = createVarsResolver((_2, { radius, fit }) => ({
  root: {
...
// node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var varsResolver54 = createVarsResolver((_2, { size: size2 }) => ({
...
var varsResolver55 = createVarsResolver((_2, { size: size2, spacing }) => ({
  root: {
...
var varsResolver56 = createVarsResolver((_2, { zIndex }) => ({
  root: {
...
var varsResolver57 = createVarsResolver(
  (_2, { radius, size: size2, yOffset, xOffset }) => ({
    root: {
...
var varsResolver58 = createVarsResolver((_2, { gap }, { size: size2 }) => ({
  group: {
...
var varsResolver59 = createVarsResolver((_2, { radius }, { size: size2 }) => ({
  root: {
...
var varsResolver62 = createVarsResolver((_2, { size: size2 }) => ({
  controls: {
...
var NumberInput = factory((_props, ref) => {
  ...
  const handlePaste = (event) => {
    ...
    const separatorsToReplace = (allowedDecimalSeparators || [".", ","]).filter(
      (s2) => s2 !== _decimalSeparator
    );
    if (separatorsToReplace.some((s2) => pastedText.includes(s2))) {
      event.preventDefault();
      let modifiedText = pastedText;
      separatorsToReplace.forEach((s2) => {
        modifiedText = modifiedText.split(s2).join(_decimalSeparator);
      });
...
var varsResolver64 = createVarsResolver((_2, { size: size2 }) => ({
  root: {
...
var varsResolver65 = createVarsResolver((_2, { size: size2 }) => ({
  root: {
...
var varsResolver66 = createVarsResolver(
  (_2, { size: size2, radius, transitionDuration }) => ({
    root: {
...
var varsResolver67 = createVarsResolver((_2, { radius }) => ({
  card: {
    "--card-radius": getRadius(radius)
  }
}));
...
var Rating = factory((_props, ref) => {
  ...
  const items = Array(_count).fill(0).map((_2, index3) => {
...
var varsResolver73 = createVarsResolver(
  (_2, { size: size2, thickness, transitionDuration }) => ({
    root: {
      "--rp-size": rem(size2),
...
var varsResolver79 = createVarsResolver((_2, { transitionDuration }) => ({
  root: {
...
var varsResolver80 = createVarsResolver((_2, { gap, align, justify }) => ({
  root: {
...
var varsResolver89 = createVarsResolver((_2, { order, size: size2, lineClamp, textWrap }) => {
...
var ee = (e, n, t = false) => {
  ...
  function r2(a, i = "--bn") {
    for (const l in a) {
      ...
      typeof a[l] != "object" ? (typeof a[l] == "number" && (a[l] = `${a[l]}px`), t ? n.style.removeProperty(d) : n.style.setProperty(d, a[l].toString())) : r2(a[l], d);
    }
  }
  return r2(e), o;
};
...
var Re = (e) => ee(Ie, e, true);
var te = (e) => (0, import_jsx_runtime344.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
  (0, import_jsx_runtime344.jsx)(Text, { size: "sm", lineClamp: 5, children: e.mainTooltip }),
  e.secondaryTooltip && (0, import_jsx_runtime344.jsx)(Text, { size: "xs", lineClamp: 5, children: e.secondaryTooltip })
] });
var O = (0, import_react438.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    At(S2, false);
    const [x, y] = (0, import_react438.useState)(false), k = o ? (0, import_jsx_runtime344.jsx)(
      Button,
      {
        "aria-label": f,
        className: t,
        onMouseDown: (w) => {
          po() && w.currentTarget.focus();
        },
        onClick: (w) => {
          y(true), d == null || d(w);
        },
    ...
    return r2 ? (0, import_jsx_runtime344.jsx)(
      Tooltip,
      {
        disabled: x,
        withinPortal: false,
        label: (0, import_jsx_runtime344.jsx)(
          te,
          {
            mainTooltip: r2,
            secondaryTooltip: a
...
var ze = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    text: o,
    icon: r2,
  ...
  At(f, false);
  const [h, S2] = (0, import_react438.useState)(false), x = (0, import_jsx_runtime344.jsxs)(
    Chip,
    {
      className: t,
      checked: a === true,
      ...
      ref: n,
      children: [
        (0, import_jsx_runtime344.jsx)("span", { children: r2 }),
        (0, import_jsx_runtime344.jsx)("span", { children: o })
      ]
    }
  );
  return !i || h ? x : (0, import_jsx_runtime344.jsx)(
    Tooltip,
    {
      refProp: "rootRef",
      withinPortal: false,
...
var Be = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: o });
});
var Ee = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    headerText: r2,
  ...
  return At(d, false), (0, import_jsx_runtime344.jsxs)(
    Card,
    {
      className: D(t, a ? "selected" : ""),
      onFocus: i,
      onBlur: l,
      tabIndex: c,
      ref: n,
      children: [
        r2 && (0, import_jsx_runtime344.jsx)(Text, { className: "bn-header-text", children: r2 }),
        o
      ]
    }
  );
});
var Le = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2, false), (0, import_jsx_runtime344.jsx)(Card.Section, { className: t, ref: n, children: o });
});
var je = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2, false), (0, import_jsx_runtime344.jsx)(
    Divider,
    {
      className: t,
      label: (0, import_jsx_runtime344.jsx)(Text, { children: o }),
      ref: n
    }
  );
});
var $e = (0, import_react438.forwardRef)((e, n) => {
  const { authorInfo: t, timeString: o, edited: r2, ...a } = e, i = S();
  return At(a, false), t === "loading" ? (0, import_jsx_runtime344.jsxs)(Group, { children: [
    (0, import_jsx_runtime344.jsx)(Skeleton, { height: 24, width: 24 }),
    (0, import_jsx_runtime344.jsx)("div", { children: (0, import_jsx_runtime344.jsx)(Skeleton, { height: 12, width: 100 }) })
  ] }) : (0, import_jsx_runtime344.jsxs)(Group, { children: [
    (0, import_jsx_runtime344.jsx)(
      Avatar,
      {
        src: t.avatarUrl,
    ...
    (0, import_jsx_runtime344.jsxs)(Text, { fz: "sm", fw: "bold", children: [
      t.username,
      (0, import_jsx_runtime344.jsxs)(Text, { fz: "xs", c: "dimmed", span: true, ml: "xs", children: [
        o,
        " ",
        r2 && `(${i.comments.edited})`
      ] })
    ] })
  ] });
});
var Ae = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    showActions: o,
    authorInfo: r2,
    ...
    children: d,
    ...f
  } = e, { hovered: h, ref: S2 } = useHover2(), x = jl([n, S2]);
  return At(f, false), (0, import_jsx_runtime344.jsxs)(Group, { pos: "relative", ref: x, className: t, children: [
    l && (o === true || o === void 0 || o === "hover" && h || c) ? (0, import_jsx_runtime344.jsx)(
      Group,
      {
        style: {
          position: "absolute",
    ...
    (0, import_jsx_runtime344.jsx)($e, { ...e }),
    d
  ] });
});
var _e = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, autoFocus: o, onFocus: r2, onBlur: a, editor: i, editable: l, ...c } = e;
  At(c, false);
  const d = q();
  return (0, import_jsx_runtime344.jsx)(
    Mt,
    {
      ...
      onFocus: r2,
      onBlur: a,
      children: (0, import_jsx_runtime344.jsx)(
        Br,
        {
...
var Ge = () => {
  ...
  return (0, import_jsx_runtime344.jsx)(qt, { blockTypeSelectItems: [], children: e });
};
var He = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r2,
  ...
  return At(re), (0, import_jsx_runtime344.jsx)(
    TextInput,
    {
      size: "xs",
      className: D(
...
var Ve = (0, import_react438.createContext)(void 0);
var Ke = (e) => {
  const { children: n, onOpenChange: t, position: o, sub: r2, ...a } = e;
  return At(a), r2 ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub,
    {
...
var Ue = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r2, checked: a, subTrigger: i, onClick: l, ...c } = e;
  return At(c, false), i ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub.Item,
    {
      className: t,
      ref: n,
      leftSection: r2,
      rightSection: a ? (0, import_jsx_runtime344.jsx)(CheckIcon, { size: 10 }) : a === false ? (0, import_jsx_runtime344.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: l,
      ...c,
      children: o
    }
...
var We = (e) => {
  ...
  return At(o), t ? (0, import_jsx_runtime344.jsx)(Menu.Sub.Target, { children: n }) : (0, import_jsx_runtime344.jsx)(Menu.Target, { children: n });
};
var Ze = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  At(a);
  const i = (0, import_react438.useContext)(Ve);
  return r2 ? (0, import_jsx_runtime344.jsx)(
    Menu.Sub.Dropdown,
    {
      className: t,
...
var qe = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return At(o), (0, import_jsx_runtime344.jsx)(Menu.Divider, { className: t, ref: n });
});
var Je = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2), (0, import_jsx_runtime344.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var Qe = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  return At(f, false), r2 ? (0, import_jsx_runtime344.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var Xe = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    tabs: o,
    defaultOpenTab: r2,
  ...
  return At(c), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime344.jsxs)(
    Tabs,
    {
      value: a,
      defaultValue: r2,
      onChange: i,
      children: [
        l && (0, import_jsx_runtime344.jsx)(LoadingOverlay, { visible: l }),
        (0, import_jsx_runtime344.jsx)(Tabs.List, { children: o.map((d) => (0, import_jsx_runtime344.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((d) => (0, import_jsx_runtime344.jsx)(Tabs.Panel, { value: d.name, children: d.tabPanel }, d.name))
      ]
    }
  ) });
});
var Ye = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r2, label: a, ...i } = e;
  return At(i), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": a,
...
var et = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r2, placeholder: a, onChange: i, ...l } = e;
  return At(l), (0, import_jsx_runtime344.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var tt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2), (0, import_jsx_runtime344.jsx)("div", { className: t, ref: n, children: o });
});
var nt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, value: o, placeholder: r2, onKeyDown: a, onChange: i, ...l } = e;
  return At(l), (0, import_jsx_runtime344.jsx)(
    TextInput,
    {
      size: "xs",
...
var ot = (e) => {
  const { open: n, onOpenChange: t, position: o, children: r2, ...a } = e;
  return At(a), (0, import_jsx_runtime344.jsx)(
    Popover,
    {
...
var rt = (e) => {
  ...
  return At(t), (0, import_jsx_runtime344.jsx)(PopoverTarget, { children: n });
};
var st = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r2,
  ...
  return At(a), (0, import_jsx_runtime344.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var at = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2, false), (0, import_jsx_runtime344.jsx)(
    Group,
    {
...
var it = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r2,
...
var lt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, id: r2, ...a } = e;
  return At(a), (0, import_jsx_runtime344.jsx)(
    Stack,
    {
      gap: 0,
...
var ct = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime344.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var dt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r2, item: a, id: i, ...l } = e;
  At(l);
  const c = (0, import_react438.useRef)(null);
  return (0, import_react438.useEffect)(() => {
    if (!c.current || !o)
      return;
    zl(
      c.current,
  ...
  }, [o]), (0, import_jsx_runtime344.jsxs)(
    Group,
    {
      gap: 0,
      className: t,
      ...
      children: [
        a.icon && (0, import_jsx_runtime344.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime344.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime344.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: a.title }),
          (0, import_jsx_runtime344.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: a.subtext })
        ] }),
        a.badge && (0, import_jsx_runtime344.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime344.jsx)(Badge, { size: "xs", children: a.badge })
          }
        )
      ]
    }
...
var ut = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, ...r2 } = e;
  return At(r2), (0, import_jsx_runtime344.jsx)(Group, { className: t, ref: n, children: o });
});
var mt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return At(o), (0, import_jsx_runtime344.jsx)(Loader, { className: t, type: "dots", size: 16, ref: n });
});
var gt = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, id: r2, columns: a, ...i } = e;
  return At(i), (0, import_jsx_runtime344.jsx)(
    "div",
    {
      className: t,
...
var ft = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, children: o, columns: r2, ...a } = e;
  return At(a), (0, import_jsx_runtime344.jsx)(
    Group,
    {
      className: t,
      ...
      ref: n,
      children: (0, import_jsx_runtime344.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o })
    }
  );
});
var ht = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r2, item: a, id: i, ...l } = e;
  At(l);
  const c = (0, import_react438.useRef)(null);
  return (0, import_react438.useEffect)(() => {
...
var bt = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var pt = (0, import_react438.forwardRef)((e, n) => {
  const { children: t, className: o, onMouseDown: r2, onClick: a, ...i } = e;
  return At(i, false), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var vt = (0, import_react438.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r2,
  ...
  return At(d, false), (0, import_jsx_runtime344.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var D2 = (0, import_react438.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
...
var _ = import_react438.default.createContext && import_react438.default.createContext(ne);
var St = ["attr", "size", "title"];
function yt(e, n) {
  if (e == null) return {};
  var t = wt(e, n), o, r2;
  if (Object.getOwnPropertySymbols) {
    ...
    for (r2 = 0; r2 < a.length; r2++)
      o = a[r2], !(n.indexOf(o) >= 0) && Object.prototype.propertyIsEnumerable.call(e, o) && (t[o] = e[o]);
  }
  return t;
}
function wt(e, n) {
...
function M(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? G(Object(t), true).forEach(function(o) {
      xt(e, o, t[o]);
...
function xt(e, n, t) {
  return n = Ct(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function Ct(e) {
  var n = Nt(e, "string");
...
function oe(e) {
  return e && e.map((n, t) => import_react438.default.createElement(n.tag, M({
    key: t
  }, n.attr), oe(n.child)));
}
function Tt(e) {
  return (n) => import_react438.default.createElement(kt, F({
    attr: M({}, e.attr)
  }, n), oe(e.child));
}
function kt(e) {
  var n = (t) => {
    var {
      ...
      size: r2,
      title: a
    } = e, i = yt(e, St), l = r2 || t.size || "1em", c;
    return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), import_react438.default.createElement("svg", F({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, i, {
      ...
      width: l,
      xmlns: "http://www.w3.org/2000/svg"
    }), a && import_react438.default.createElement("title", null, a), e.children);
  };
  return _ !== void 0 ? import_react438.default.createElement(_.Consumer, null, (t) => n(t)) : n(ne);
}
function Pt(e) {
...
var I = (0, import_react438.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r2, ...a } = e;
  At(a);
  const i = o.filter((l) => l.isSelected)[0];
  return i ? (0, import_jsx_runtime344.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      middlewares: { flip: true, shift: true, inline: false, size: true },
      children: [
        (0, import_jsx_runtime344.jsx)(Menu.Target, { children: (0, import_jsx_runtime344.jsx)(
          Button,
          {
            onMouseDown: (l) => {
              po() && l.currentTarget.focus();
            },
            leftSection: i.icon,
            rightSection: (0, import_jsx_runtime344.jsx)(Pt, {}),
            size: "xs",
            variant: "subtle",
            disabled: r2,
            children: i.text
        ...
        (0, import_jsx_runtime344.jsx)(Menu.Dropdown, { className: t, ref: n, children: o.map((l) => (0, import_jsx_runtime344.jsx)(
          Menu.Item,
          {
            onClick: l.onClick,
            leftSection: l.icon,
            rightSection: l.isSelected ? (0, import_jsx_runtime344.jsx)(CheckIcon, { size: 10, className: "bn-tick-icon" }) : (
              // Ensures space for tick even if item isn't currently selected.
              (0, import_jsx_runtime344.jsx)("div", { className: "bn-tick-space" })
            ),
...
var Ft = {
  ...
  Generic: {
    ...
    Form: {
      Root: (e) => (0, import_jsx_runtime344.jsx)("div", { children: e.children }),
      TextInput: He
    },
    Menu: {
      Root: Ke,
...
var Mt = (e) => {
  const { className: n, theme: t, ...o } = e, r2 = q(), a = yi(), i = (r2 == null ? void 0 : r2.colorSchemePreference) || a, l = (0, import_react438.useCallback)(
    (h) => {
    ...
    [i, t]
  ), c = (0, import_react438.useContext)(MantineContext), d = typeof t == "string" ? t : i !== "no-preference" ? i : "light", f = (0, import_jsx_runtime344.jsx)(ao.Provider, { value: Ft, children: (0, import_jsx_runtime344.jsx)(
    Ml,
    {
  ...
  return c ? f : (0, import_jsx_runtime344.jsx)(
    MantineProvider,
    {
