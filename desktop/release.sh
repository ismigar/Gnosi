...
echo "  4. Inspect the candidate artifact in the Build Release Candidate workflow run (retained 5 days)."
echo "     The workflow does not create a draft or publish/update a GitHub release."
echo "     Publication remains disabled until native, Docker, installer and 2.x upgrade acceptance is complete."
